...
Native `datexport.dll`, LOTRO DAT'ları, TM/catalog verileri ve model runtime'ları bu public çalışma kopyasına dahil edilmez. Native dosya yalnız lisans/redistribution onayı bulunan yerel build ortamında sağlanmalıdır.
