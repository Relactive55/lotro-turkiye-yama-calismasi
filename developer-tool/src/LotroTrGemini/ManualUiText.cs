...
public static class ManualUiText
{
	...
	private static readonly Dictionary<string, string> Exact = new Dictionary<string, string>(StringComparer.Ordinal)
	{
		...
		{ "Woman", "Kadın" }, { "Naming Guidelines TBD", "Adlandırma Kuralları" },
		{ "SHOULD NOT BE USED", "KULLANILMAMALI" },
		{ "This option is NYI.", "Bu seçenek henüz uygulanmadı." },
		{ "Male elves. Blah blah blah.", "Erkek elfler." },
		{ "Female elves. Blah blah blah.", "Kadın elfler." },
		{ "Those crazy male hobbits. Blah blah blah.", "Erkek hobbitler." },
		{ "Those crazy female hobbits. Blah blah blah.", "Kadın hobbitler." },
		{ "The male men. Blah blah blah.", "Erkek insanlar." },
		{ "The female men? Huh? Blah blah blah.", "Kadın insanlar." },
		...
		{ "\\nNot as long-lived as Elves, sturdy as dwarves, or resilient as hobbits, Men are renowned for their courage and resourcefulness.\\n\\n",
			"\\nElfler kadar uzun ömürlü, Cüceler kadar sağlam veya Hobbitler kadar dayanıklı olmasalar da İnsanlar cesaretleri ve beceriklilikleriyle tanınır.\\n\\n" },
		{ "Not as long-lived as Elves, sturdy as dwarves, or resilient as hobbits, Men are renowned for their courage and ingenuity. They are a strong people, fated to become the dominant people of Middle-earth, though they are also weaker of will and more prone to the temptations and wiles of the Enemy.",
			"Elfler kadar uzun ömürlü, Cüceler kadar sağlam veya Hobbitler kadar dayanıklı olmasalar da İnsanlar cesaretleri ve beceriklilikleriyle tanınır. Güçlü bir halktır; Orta Dünya'nın baskın halkı olmaya yazgılıdırlar, ancak iradeleri daha zayıftır ve Düşman'ın ayartılarına ve hilelerine daha açıktırlar." },
		...
		{ "Increased Morale Restoration- Men can be roused to action faster than the other races.  (heals heal for more on men)",
			"Artan Moral Yenilenmesi - İnsanlar diğer ırklara göre daha çabuk toparlanır. (İyileştirme etkileri İnsanlar üzerinde daha güçlüdür.)" },
		{ "Increased Morale Restoration- Men are more quickly emboldened than the other races.",
			"Artan Moral Yenilenmesi - İnsanlar diğer ırklara göre daha çabuk cesaretlenir." },
		{ "Improved Strength - The feats of strength that men such as Boromir could accomplish are worthy of song.",
			"Geliştirilmiş Kuvvet - Boromir gibi insanların sergileyebildiği güç gösterileri şarkılara değerdir." },
